...
#		geom_smooth(method='glm',formula=y~x,aes(group=name),fill='grey80',linetype='dashed',size=.6)+
		...
		theme_bw() + theme(legend.position="none")+ ylim(250,310)+
		xlab("Departure DOY") + ylab("Arrival DOY")
...
#		geom_smooth(method='glm',formula=y~x,aes(group=name),fill='grey80',linetype='dashed',size=.6)+
		...
		scale_colour_manual(values=c("LC"="blue","SW"="red"))+
		theme_bw() + theme(legend.position="none")+ ylim(250,310)+
		xlab("Nr. stop-over days") + ylab("Arrival DOY")
...
#		geom_smooth(method='glm',formula=y~x,aes(group=name),fill='grey80',linetype='dashed',size=.6)+
		...
		ylab("Duration migration") + xlab("Nr. stop-over days")
...
#		geom_smooth(method='glm',formula=y~x,aes(group=name),fill='grey80',linetype='dashed',size=.6)+
		...
		scale_colour_manual(values=c("LC"="blue","SW"="red"))+
		theme_bw() + theme(legend.position="none")+
		ylab("Nr. stopover days") + xlab("Departure DOY")
...
#		geom_smooth(method='glm',formula=y~x,aes(group=name),fill='grey80',linetype='dashed',size=.6)+
		...
		scale_fill_manual(values=c("LC"="blue","SW"="red"))+
		scale_colour_manual(values=c("LC"="blue","SW"="red"))+
		theme_bw() + theme(legend.position="none")+ ylim(85,125)+
		xlab("Departure DOY") + ylab("Arrival DOY")

p4 <- ggplot(data=full,aes(y=arr.spr.yday,x=stop.days.spr,col=pop,fill=pop)) +
#		geom_smooth(method='glm',formula=y~x,aes(group=name),fill='grey80',linetype='dashed',size=.6)+
		 geom_point()+ geom_smooth(method='glm',formula=y~x,aes(group=pop))+
		scale_fill_manual(values=c("LC"="blue","SW"="red"))+
		scale_colour_manual(values=c("LC"="blue","SW"="red"))+
		theme_bw() + theme(legend.position="none")+ ylim(85,125)+
		xlab("Nr. stop-over days") + ylab("Arrival DOY")
