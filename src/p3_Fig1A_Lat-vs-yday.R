...
##OLD COLOUR SCHEME FOR INDIVIDUALS
  	scale_colour_manual(name="ID",values=c("BE_M1"="cyan3","BE_M2"="darkorange2","BE_M3"="magenta2",
  							   ...
  							   "SW_M2"="khaki2"))+
# layout figure
  scale_x_continuous(breaks=c(0,0+31,0+31+28,0+2*31+28,0+28+2*31+1*30,0+29+3*31+1*30,0+29+3*31+2*30,
...
ggsave('FigS1_Lat-vs-yday_v22102018.tiff',dpi=300,width=8,height=4)
